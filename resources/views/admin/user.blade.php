      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="/dashboard">Om Sai Tour</a>
          </div>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <div class="photo">
                    <img src="{{asset('images/anime3.png')}}" alt="Profile Photo">
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 px-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Username" value="yogesh6717">
                      </div>
                    </div>
                ...
                <p class="card-text">
                  <div class="author">
                    ...
                    <a href="javascript:void(0)">
                      ...
                      <h5 class="title">Yogesh Patil</h5>
                    </a>
                    <p class="description">
                      Ceo/Co-Founder
                    </p>
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="copyright">
            ...
            <a href="http://www.yogeshpatil.epizy.com" target="_blank">Yogesh Patil</a> for a Mayur's Travel Site.
          </div>
        </div>
      </footer>
    </div>
...
@endif
  ...
  <script>
    $(document).ready(function() {
      // Javascript method's body can be found in s/js/demos.js
